            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                <div className="mb-1 flex items-center justify-between">
                  <label htmlFor="password" className="block text-xs font-medium text-ink dark:text-ink-dark">
                    Password
                  </label>
              ...
              <label className="flex items-center gap-2 text-xs text-ink-muted dark:text-ink-muted-dark">
                <input
                  type="checkbox"
                  checked={remember}
                  onChange={(e) => setRemember(e.target.checked)}
                  className="h-3.5 w-3.5 rounded border-border accent-brand dark:border-border-dark"
                />
              ...
              >
                {loading ? "Signing in…" : "Sign in to Radar"}
